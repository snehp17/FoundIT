          ...
          >
            <div className="px-6 py-5 border-b border-secondary-100">
              <div className="flex items-center gap-2 text-error mb-1">
                ...
                <span className="text-xs font-semibold uppercase tracking-wider">Report Lost Item</span>
              </div>
            ...
            <div className="p-6 space-y-5">
              ...
              {step === 1 && (
                <>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      <label className="block text-sm font-semibold text-secondary-900 mb-2">Date Lost *</label>
                      <input
                        type="date"
                        className="input-field"
                        value={form.date}
