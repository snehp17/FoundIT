...
import { User, Mail, Phone, Building2, Shield, Camera, CheckCircle2, Star, Package, TrendingUp, Award } from 'lucide-react'
          ...
          <div className="px-6 pb-6">
            <div className="flex flex-col sm:flex-row sm:items-end gap-4 mb-4">
              <div className="relative -mt-10 self-start sm:self-auto">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600 to-blue-800 border-4 border-white shadow-lg flex items-center justify-center text-white text-2xl font-bold">
                  PS
                </div>
              ...
              <div className="pb-1 flex items-center gap-3">
                <div className="flex items-center gap-1.5 badge-success py-1.5 px-3">
          ...
          <div className="lg:col-span-2 bg-surface rounded-3xl border border-secondary-100 shadow-md p-6">
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: Mail, label: 'University Email', key: 'email', type: 'email' },
                { icon: Phone, label: 'Phone Number', key: 'phone', type: 'tel' },
                { icon: Building2, label: 'University', key: 'university', type: 'text' },
                { icon: Shield, label: 'Roll Number', key: 'rollNo', type: 'text' },
              ].map(field => (
